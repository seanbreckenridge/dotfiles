...
function M.dial(increment, g)
    ...
    local func = (increment and "inc" or "dec") .. (g and "_g" or "_") ..
        ...
        return {
            ...
            groups = {
                ...
                typescript = {
                    ...
                    ordinal_numbers, weekdays, months
                },
                css = {
                    augend.integer.alias.decimal, -- nonnegative and negative decimal number
                ...
                markdown = {
                    augend.misc.alias.markdown_header, ordinal_numbers,
                    weekdays, months
                },
                json = {
                    augend.integer.alias.decimal, -- nonnegative and negative decimal number
                ...
                python = {
                    augend.integer.alias.decimal, -- nonnegative and negative decimal number
                    capitalized_boolean, logical_alias, ordinal_numbers,
                    weekdays, months
                }
            }
        }
